...
echo $this->Form->input('w1', array('onmouseover' => "this.select();"));
echo $this->Form->input('w2', array('onmouseover' => "this.select();"));
echo $this->Form->input('w3', array('onmouseover' => "this.select();"));
